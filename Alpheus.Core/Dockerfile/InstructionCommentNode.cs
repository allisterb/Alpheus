...
namespace Alpheus
{
    public class InstructionCommentNode : InstructionNode
    {
        ...
        public InstructionCommentNode(int line, AString value) : base("Line_" + line.ToString() + "_Comment", new List<AString> { value })
        {
            this.Value = value;
        }

        public static implicit operator XElement(InstructionCommentNode c)
        {
