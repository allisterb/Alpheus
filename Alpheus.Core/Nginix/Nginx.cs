...
namespace Alpheus
{
    public partial class Nginx : ConfigurationFile<DirectiveSection, DirectiveNode>
    {
        ...
        public Nginx(IFileInfo file, AlpheusEnvironment env, bool read_file = true, bool parse_file = true, Func<ConfigurationFile<DirectiveSection, DirectiveNode>, string, string> read_file_lambda = null) 
            : base(file, "//include/Arg", env, read_file, parse_file, read_file_lambda) { }
        #endregion
        ...
        {
            return new Nginx(file, this.AlEnvironment, read_file, parse_file, read_file_lambda);
        }
        #endregion
    }
}
