...
namespace Alpheus
{
    public class CommandCommentNode : CommandNode
    {
        ...
        public CommandCommentNode(int line, AString value) : base("Line_" + line.ToString() + "_Comment", new List<AString> { value })
        {
            this.Value = value;
        }

        public static implicit operator XElement(CommandCommentNode c)
        {
